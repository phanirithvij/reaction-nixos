...
PRIMARY_TRACK_ID = os.environ['TRACK1']
DUPLICATE_TRACK_ID = os.environ['TRACK2']
...
def merge_tracks():
    ...
    primary_track = Track.objects.get(pk=PRIMARY_TRACK_ID)
    duplicated_track = Track.objects.get(pk=DUPLICATE_TRACK_ID)
