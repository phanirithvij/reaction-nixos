  ...
  config =
    ...
    lib.mkIf cfg.enable {
      assertions = [
        {
          assertion =
            cfg.autoScan.enable -> (cfg.autoScan.passwordFile != null && cfg.autoScan.startAt != null);
      ...
      systemd.services = {
        funkwhale2-init = {
          ...
          before = [
            "redis-funkwhale2.service"
          ]
          ++ lib.optionals cfg.enableLocalTypesense [ "typesense.service" ];
          serviceConfig = {
            Type = "oneshot";
            User = "root";
          };
