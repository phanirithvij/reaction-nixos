...
in {
  ...
  # Low prio startup
  (let
    wantedbytarget3 = { wantedBy = lib.mkForce [ "multi-user3.target" ]; };
  in {
    systemd.services = {
      "directus-5eroue" = wantedbytarget3;
      "directus-leborddeleau" = wantedbytarget3;
      "directus-edit.ppom.fr" = wantedbytarget3;
      "directus-pompeani.art" = wantedbytarget3;
    };
  })
]
